...
// Pin wiring (Seeed XIAO ESP32C3 D-labels -> actual GPIO):
// DIN (MOSI) -> D4 -> GPIO6
// CLK (SCK)  -> D5 -> GPIO7
// CS         -> D7 -> GPIO20
// DC         -> D1 -> GPIO3
...
// 1.54'' EPD Module
GxEPD2_4C<GxEPD2_154c_GDEM0154F51H, GxEPD2_154c_GDEM0154F51H::HEIGHT> display(GxEPD2_154c_GDEM0154F51H(CS_PIN, DC_PIN, RES_PIN, BUSY_PIN));
